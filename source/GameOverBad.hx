...
class GameOverBad extends MusicBeatState
{
	...
	override function create()
	{
		...
		//add(bg);
		var good:FlxSprite = new FlxSprite().loadGraphic('assets/images/badending.png');
		FlxG.sound.playMusic("assets/music/badending.ogg", 0.75, false);
