...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		if(Config.betterIcons){
			...
			animation.add('torrent', [53, 55, 54], 0, false, isPlayer);
			animation.add('torrent-pixel', [58, 56, 57], 0, false, isPlayer);
			...
			animation.add('torrent', [53, 54], 0, false, isPlayer);
			animation.add('torrent-pixel', [56, 57], 0, false, isPlayer);
		}
