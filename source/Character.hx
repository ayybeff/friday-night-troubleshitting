	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				animation.addByPrefix('SHESFUCKINGGONE', 'GF glitch out', 24, false);

				addOffset('cheer');
				addOffset('sad', -2, -21);
				addOffset('danceLeft', 0, -9);
				addOffset('danceRight', 0, -9);
				addOffset('SHESFUCKINGGONE', 595, 265);
			...
			case 'dad':
				...
				playAnim('idle');
			case 'torrent':
				frames = Paths.getSparrowAtlas("TORRENT");
				animation.addByPrefix('idle', 'idle', 24, false);
				animation.addByPrefix('singUP', 'up', 24);
				animation.addByPrefix('singRIGHT', 'right', 24);
				animation.addByPrefix('singDOWN', 'down', 24);
				animation.addByPrefix('singLEFT', 'left pose', 24);
				animation.addByPrefix('specialAnim', 'ur going to lol', 24);
				animation.addByPrefix('specialAnimYeah', 'torrent YEAH', 24);

				addOffset('idle');
				addOffset("singUP", 11, 74);
				addOffset("singRIGHT", -9, -5);
				addOffset("singLEFT", 140, -12);
				addOffset("singDOWN", 81, -121);
				addOffset("specialAnim", 35, 99);
				addOffset("specialAnimYeah", 1, 7);

				playAnim('idle');

			case 'torrent-pixel':
				frames = Paths.getSparrowAtlas("pixel_torrent");
				animation.addByPrefix('idle', 'idle', 24, false);
				animation.addByPrefix('singUP', 'up', 24);
				animation.addByPrefix('singRIGHT', 'right', 24);
				animation.addByPrefix('singDOWN', 'down', 24);
